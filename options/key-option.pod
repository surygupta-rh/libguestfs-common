...
=item B<--key> NAMEB<:error>

=item B<--key> UUIDB<:error>

=item B<--key> B<all:error>

Any encrypted device matching will cause an error.
S<I<--key all:error>> can be used to reject any disk image that
contains an encrypted partition.
